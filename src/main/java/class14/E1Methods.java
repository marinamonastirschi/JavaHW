...
public class E1Methods {
    ...
    /*void=> return type of the method void means this method does not return any data other examples of return
    types can be String int boolean char Dog Cat etc.
    printWord=> parameters/input
    {sout(word);}=> body of the method you can write if else conditions loop
     */
